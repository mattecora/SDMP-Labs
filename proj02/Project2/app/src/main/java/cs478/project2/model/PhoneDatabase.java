...
public class PhoneDatabase {
    ...
    public final static Phone IPHONE_11 =
            new Phone("Apple", "iPhone 11", "6.1 inches", "$699-$849",
                    R.mipmap.small_iphone_11, R.mipmap.iphone_11, "https://www.apple.com/iphone-11/",
                    Arrays.asList(
    ...
    public final static Phone IPHONE_11_PRO =
            new Phone("Apple", "iPhone 11 Pro", "5.8 inches", "$999-$1349",
                    R.mipmap.small_iphone_11_pro, R.mipmap.iphone_11_pro, "https://www.apple.com/iphone-11-pro/",
                    Arrays.asList(
    ...
    public final static Phone IPHONE_11_PRO_MAX =
            new Phone("Apple", "iPhone 11 Pro Max", "6.5 inches", "$1099-$1449",
                    R.mipmap.small_iphone_11_pro_max, R.mipmap.iphone_11_pro_max, "https://www.apple.com/iphone-11-pro/",
                    Arrays.asList(
    ...
    public final static Phone PIXEL_3 =
            new Phone("Google", "Pixel 3", "5.5 inches", "$799-$899",
                    R.mipmap.small_pixel_3, R.mipmap.pixel_3, "https://store.google.com/product/pixel_3",
                    Arrays.asList(
    ...
    public final static Phone PIXEL_3_XL =
            new Phone("Google", "Pixel 3 XL", "6.3 inches", "$899-$999",
                    R.mipmap.small_pixel_3_xl, R.mipmap.pixel_3_xl, "https://store.google.com/product/pixel_3",
                    Arrays.asList(
    ...
    public final static Phone PIXEL_3A =
            new Phone("Google", "Pixel 3a", "5.5 inches", "$399",
                    R.mipmap.small_pixel_3a, R.mipmap.pixel_3a, "https://store.google.com/product/pixel_3",
                    Arrays.asList(
    ...
    public final static Phone PIXEL_3A_XL =
            new Phone("Google", "Pixel 3a XL", "6.3 inches", "$479",
                    R.mipmap.small_pixel_3a_xl, R.mipmap.pixel_3a_xl, "https://store.google.com/product/pixel_3",
                    Arrays.asList(
    ...
    public final static Phone GALAXY_S10E =
            new Phone("Samsung", "Galaxy S10e", "5.8 inches", "$749-$849",
                    R.mipmap.small_galaxy_s10e, R.mipmap.galaxy_s10e, "https://www.samsung.com/us/mobile/galaxy-s10/",
                    Arrays.asList(
    ...
    public final static Phone GALAXY_S10 =
            new Phone("Samsung", "Galaxy S10", "6.1 inches", "$899-$1149",
                    R.mipmap.small_galaxy_s10, R.mipmap.galaxy_s10, "https://www.samsung.com/us/mobile/galaxy-s10/",
                    Arrays.asList(
    ...
    public final static Phone GALAXY_S10PLUS =
            new Phone("Samsung", "Galaxy S10+", "6.4 inches", "$999-$1249",
                    R.mipmap.small_galaxy_s10_plus, R.mipmap.galaxy_s10_plus, "https://www.samsung.com/us/mobile/galaxy-s10/",
                    Arrays.asList(
